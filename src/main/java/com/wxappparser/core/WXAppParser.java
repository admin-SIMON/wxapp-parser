...
import com.wxappparser.model.WXAPPFile;
import com.wxappparser.model.WXAPPPackage;
import com.wxappparser.utils.ByteUtils;
import com.wxappparser.utils.FileUtils;
...
public class WXAppParser {
    ...
    public WXAPPPackage parse(String path) throws IOException, InvalidWXPackageException {
        ...
        ArrayList<WXAPPFile> wxappFiles = new ArrayList<WXAPPFile>();
